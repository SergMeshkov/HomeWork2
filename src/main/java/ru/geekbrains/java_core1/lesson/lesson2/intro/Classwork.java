...
//       arrySimpleExample();
    ...
    private static void arrySimpleExample() {
        int[ ] arr;
        arr = new int[5];
        arr[0] = 10;
        arr[1] = 20;
...
//        System.out.println(arr[5]);
    ...
    printSomethingIntoConsole();
        ...
        double someNumber = calculatesSomeExpression(.24,5.25);
    }
    ...
    public static double calculatesSomeExpression(double firstValue, double secondValue) {
        double result = firstValue / secondValue;
        System.out.println("Calkukation....");
